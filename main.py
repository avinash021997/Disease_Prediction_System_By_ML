...
def refresh():
    root.destroy()
    os.popen("python clean_code.py") #change refresh.py according to yours program name
# gui_stuff------------------------------------------------------------------------------------
...
# Heading
w2 = Label(root, justify=CENTER, text="Disease Prediction System using ML", fg="white", bg="black")
w2.config(font=("Elephant", 30))
w2.grid(row=1, column=1, columnspan=2, padx=100)
w2 = Label(root, justify=CENTER ,text="By Avinash Kokate", fg="white", bg="black")
...
#reset = Button(root, text="Reset", command=refresh,bg="green",fg="black")
#reset.grid(row=19, column=3,padx=10)
